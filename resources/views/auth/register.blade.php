        ...
        <div class="outer-panel">
            <div class="container">
                <div class="process-title">
                    <h2 id="step-title-1" class="step-title is-active">Welcome Hapiverse Socialite, select an account type.</h2>
                </div>
                <div id="signup-panel-1" class="process-panel-wrap is-active">
                    <div class="row">
                        <div class="col-md-4 offset-md-2">
                            <div class="account-type mb-3 mb-md-0">
                                <div class="type-image">
                                    <img class="type-bg light-image" src="{{asset('libraries/assets/img/illustrations/signup/type-3.svg')}}" alt="">
                                </div>
                                <h3>Premium Signup</h3>
                                <p>Create a premium signup account to be able to do some awesome things.</p>
                                <a href="{{route('premium')}}" class="button is-fullwidth process-button" data-step="step-dot-2">
                                    Continue
                                </a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="account-type">
                                <div class="type-image">
                                    ...
                                    <img class="type-bg light-image" src="{{asset('libraries/assets/img/illustrations/signup/type-2-bg-dark.svg')}}" alt="">
                                </div>
                                <h3>Reffer Code</h3>
                                <p>Create a reffer code account to be able to do some awesome things.</p>
                                <a href="{{route('reffer-code')}}" class=" button is-fullwidth process-button">
                                    Continue
                                </a>
                            </div>
                        </div>
