                        ...
                        <div class="column is-5" style="margin-left:auto; margin-right:300px ;">
                            <div class="account-type">
                                <div class="type-image">
                                    ...
                                    <img class="type-bg light-image" src="{{asset('libraries/assets/img/email.webp')}}" alt="">
                                </div>
                                @if ($errors->any())
                                ...
                                <form method="POST" action="{{route('email.verify')}}">
                                    ...
                                    <div class="field">
                                        ...
                                        <p>we will send you OTP verification code you will enter below</p>
                                        <div class="control">
                                            <input type="email" class="input" placeholder="Enter email" name="email" required>
                                            <input type="hidden" name="refferCode" value="{{$getRefferCode}}">
                                        </div>
                                        @if ($errors->has('email'))
