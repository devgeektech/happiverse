                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="slocation-tab" data-bs-toggle="tab" data-bs-target="#slocation-tab-pane" type="button" role="tab" aria-controls="slocation-tab-pane" aria-selected="true">Shared Location</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="lrequests-tab" data-bs-toggle="tab" data-bs-target="#lrequests-tab-pane" type="button" role="tab" aria-controls="lrequests-tab-pane" aria-selected="false" tabindex="-1">Requests</button>
                                </li>
                            </ul>
                            <div class="tab-content" id="myTabContent">
                             
                                <div class="tab-pane fade active show" id="slocation-tab-pane" role="tabpanel" aria-labelledby="slocation-tab" tabindex="0">
                                        ...
                                        <li class="list-item">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <a class="d-flex align-items-center gap-2" href="">
                                                    <img class="user-img" src="{{'http://127.0.0.1:8000/'.$profile_image_url }}" style = "margin-top:10px">
                                                    <div>
                                ...
                                <div class="tab-pane fade" id="lrequests-tab-pane" role="tabpanel" aria-labelledby="lrequests-tab" tabindex="0">
                                    <ul class="friends-list">
                                        ...
                                        <li class="list-item">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <a class="d-flex align-items-center gap-2" href="">
                                                    <img class="user-img" src="{{'http://127.0.0.1:8000/'.$profileImageUrl??""}}" style = "margin-top:10px">
                                                    <div>
