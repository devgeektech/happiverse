@php
use App\Models\Post;
$userDeatil=\Auth::user()->getUserDetail ?? '';
$posts=Post::where('content_type','feeds')->get();
                    ...
                    <div class="card">
                        ...
                        <div class="card-body no-padding">
                            ...
                            <div class="page-block transition-block">
                                <img src="{{asset('userdoc/'.$userDeatil->profileImageUrl)}}" data-demo-src="{{asset('userdoc/'.$userDeatil->profileImageUrl)}}" data-page-popover="0" alt="">
                                <div class="page-meta">
                                    <span>
                                        <bold>Name:</bold> {{$userDeatil->userName}}
                                    </span>
                                </div>
                            </div>
                            <div class="page-block transition-block">
                                <div class="page-meta">
                                    <span>
                                        ...
                                        <bold>Gender: </bold>{{$userDeatil->userName}}
                                    </span>
                            ...
                            <div class="page-block transition-block">
                                <div class="page-meta">
                                    <span>
                                        ...
                                        <bold>Height: </bold> {{$userDeatil->height}}
                                    </span>
                            ...
                            <div class="page-block transition-block">
                                <div class="page-meta">
                                    <span>
                                        ...
                                        <bold>Hair Color: </bold> {{$userDeatil->hairColor}}
                                    </span>
                            ...
                            <div class="page-block transition-block">
                                <div class="page-meta">
                                    <span>
                                        ...
                                        <bold>Location: </bold> {{$userDeatil->city .','. $userDeatil->country}}
                                    </span>
                    ...
                    <div class="shared-publication">
                        ...
                        <div class="publication-meta">
                            <div class="inner-flex">
                                ...
                                <p id="share-modal-text">{{$post->caption}}</p>
                            </div>
