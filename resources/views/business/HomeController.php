...
class HomeController extends Controller
{
    ...
    public function getPost(Request $request)
    {
        ...
        $stories = Post::orderBy('postId', 'DESC')->where('content_type', 'story')->get();
        $results = Post::orderBy('postId', 'DESC')->where('content_type', 'feeds')->paginate(10);
        $artilces = '';
        ...
        if ($request->ajax()) {
            foreach ($results as $result) {
                ...
                <a href="" class="more-option"><img alt="" src="';
        ...
        <div class="card-footer">
            ...
            <div class="likes-wrapper">
                ...
                <p class="likes-status">Liked by <b>Will Smith</b> and <b>1,993 other</b></p>
            </div>
            <div id="commentAccordion" class="accordion-collapse collapse mb-3" aria-labelledby="headingOne" data-bs-parent="#commentAccordHead">
                ...
                $artilces .= url('add-comment/' . $result->postId);
            ...
            <div class="comments-wrapper">
                <div>
                    <p class="comment-text"><span>Becca John</span> Lorem ipsum dolor sit amet
        ...
        return view('user-web.home', compact('stories'));
    }
    ...
    public function businessDashboard(Request $request)
    {
        ...
        return view('business.home', compact('stories'));
    }

    public function storyDetail($id)
    {
        $stories = PostImages::where('postId', $id)->get();
        $userStories = Post::where('content_type', 'story')->get();
        return view('user-web.story-detail', compact('stories', 'userStories'));
    }
}
